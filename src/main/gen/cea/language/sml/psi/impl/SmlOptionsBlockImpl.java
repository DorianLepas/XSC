...
public class SmlOptionsBlockImpl extends ASTWrapperPsiElement implements SmlOptionsBlock {

  public SmlOptionsBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitOptionsBlock(this);
  }
