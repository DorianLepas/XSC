...
public class SmlThreadStateInstructionImpl extends ASTWrapperPsiElement implements SmlThreadStateInstruction {

  public SmlThreadStateInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitThreadStateInstruction(this);
  }
