...
public class SmlExitBlockImpl extends ASTWrapperPsiElement implements SmlExitBlock {

  public SmlExitBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitExitBlock(this);
  }
