...
public class SmlThreadEndInstructionImpl extends ASTWrapperPsiElement implements SmlThreadEndInstruction {

  public SmlThreadEndInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitThreadEndInstruction(this);
  }
