...
public class SmlParser implements PsiParser, LightPsiParser {
  ...
  public static boolean aliasBlock(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, beginBlock(b, l + 1)) && r;
    r = p && report_error_(b, aliasBlock_4(b, l + 1)) && r;
    r = p && endBlock(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // aliasBlockBody?
  private static boolean aliasBlock_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "aliasBlock_4")) return false;
    aliasBlockBody(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // (smlVars DOT_SEPARATOR? smlVars?) | (((THREAD_KEYWORD|PROCESS_KEYWORD) identificationKey) DOT_SEPARATOR smlVars)
  public static boolean setProperty(PsiBuilder b, int l) {
    ...
    r = setProperty_0(b, l + 1);
    if (!r) r = setProperty_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // smlVars DOT_SEPARATOR? smlVars?
  private static boolean setProperty_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "setProperty_0")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = smlVars(b, l + 1);
    p = r; // pin = 1
    r = r && report_error_(b, setProperty_0_1(b, l + 1));
    r = p && setProperty_0_2(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // DOT_SEPARATOR?
  private static boolean setProperty_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "setProperty_0_1")) return false;
    consumeToken(b, DOT_SEPARATOR);
    return true;
  }

  // smlVars?
  private static boolean setProperty_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "setProperty_0_2")) return false;
    smlVars(b, l + 1);
    return true;
  }

  // ((THREAD_KEYWORD|PROCESS_KEYWORD) identificationKey) DOT_SEPARATOR smlVars
  private static boolean setProperty_1(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, consumeToken(b, DOT_SEPARATOR));
    r = p && smlVars(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // (THREAD_KEYWORD|PROCESS_KEYWORD) identificationKey
  private static boolean setProperty_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "setProperty_1_0")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = setProperty_1_0_0(b, l + 1);
    p = r; // pin = 1
  ...
  private static boolean setProperty_1_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "setProperty_1_0_0")) return false;
    boolean r;
    r = consumeToken(b, THREAD_KEYWORD);
    if (!r) r = consumeToken(b, PROCESS_KEYWORD);
    return r;
  ...
  /* ********************************************************** */
  // smlVars|THREAD_KEYWORD|PROCESS_KEYWORD
  ...
  /* ********************************************************** */
  // (JAVA_FUNCTION_CALL|TRACE_MESSAGE_STRING|SML_VARS|THREAD_KEYWORD|PROCESS_KEYWORD) (TRACE_MESSAGE_SEPARATOR (TRACE_MESSAGE_STRING|SML_VARS|THREAD_KEYWORD|PROCESS_KEYWORD|JAVA_FUNCTION_CALL))*
  ...
  // JAVA_FUNCTION_CALL|TRACE_MESSAGE_STRING|SML_VARS|THREAD_KEYWORD|PROCESS_KEYWORD
  private static boolean traceMessage_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "traceMessage_0")) return false;
    boolean r;
    r = consumeToken(b, JAVA_FUNCTION_CALL);
    if (!r) r = consumeToken(b, TRACE_MESSAGE_STRING);
    if (!r) r = consumeToken(b, SML_VARS);
    if (!r) r = consumeToken(b, THREAD_KEYWORD);
    if (!r) r = consumeToken(b, PROCESS_KEYWORD);
    return r;
  ...
  // (TRACE_MESSAGE_SEPARATOR (TRACE_MESSAGE_STRING|SML_VARS|THREAD_KEYWORD|PROCESS_KEYWORD|JAVA_FUNCTION_CALL))*
  ...
  // TRACE_MESSAGE_STRING|SML_VARS|THREAD_KEYWORD|PROCESS_KEYWORD|JAVA_FUNCTION_CALL
