...
public class XCSSvProperty_Impl extends ASTWrapperPsiElement implements XCSSvProperty_ {

  public XCSSvProperty_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull XCSVisitor visitor) {
    visitor.visitSvProperty_(this);
  }
