...
public class XCSSvCoreImpl extends ASTWrapperPsiElement implements XCSSvCore {

  public XCSSvCoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull XCSVisitor visitor) {
    visitor.visitSvCore(this);
  }
  ...
  @Override
  @Nullable
  public XCSSvProperty getSvProperty() {
    return findChildByClass(XCSSvProperty.class);
  }
