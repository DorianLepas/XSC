...
package org.intellij.sdk.language.xsc.parser;
...
public class XCSParser implements PsiParser, LightPsiParser {
  ...
  //                   (CORE_START LIST_TYPE VARIABLE_NAME? FUNCTION_COMMENT? FUNCTION_CORE* CORE_END FUNCTION_COMMENT?) |
  ...
  private static boolean FUNCTION_CORE_2_4(PsiBuilder b, int l) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(b, "FUNCTION_CORE_2_4", c)) break;
    }
    return true;
  }

  // FUNCTION_COMMENT?
  private static boolean FUNCTION_CORE_2_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "FUNCTION_CORE_2_6")) return false;
    consumeToken(b, FUNCTION_COMMENT);
    return true;
  }
