...
public class XCSCeListImpl extends ASTWrapperPsiElement implements XCSCeList {

  public XCSCeListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull XCSVisitor visitor) {
    visitor.visitCeList(this);
  }
  ...
  @Override
  @NotNull
  public List<XCSCeCore> getCeCoreList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, XCSCeCore.class);
  }
