...
public class SmlConsumeEventInstructionImpl extends ASTWrapperPsiElement implements SmlConsumeEventInstruction {

  public SmlConsumeEventInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitConsumeEventInstruction(this);
  }
