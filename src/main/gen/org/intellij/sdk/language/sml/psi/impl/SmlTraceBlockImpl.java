...
public class SmlTraceBlockImpl extends ASTWrapperPsiElement implements SmlTraceBlock {

  public SmlTraceBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitTraceBlock(this);
  }
