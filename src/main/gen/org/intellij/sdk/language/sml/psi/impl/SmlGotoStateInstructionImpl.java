...
public class SmlGotoStateInstructionImpl extends ASTWrapperPsiElement implements SmlGotoStateInstruction {

  public SmlGotoStateInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitGotoStateInstruction(this);
  }
