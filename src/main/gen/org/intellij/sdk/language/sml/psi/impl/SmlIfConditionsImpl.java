...
public class SmlIfConditionsImpl extends ASTWrapperPsiElement implements SmlIfConditions {

  public SmlIfConditionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitIfConditions(this);
  }
