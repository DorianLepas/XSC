...
public class SmlProcessStateInstructionImpl extends ASTWrapperPsiElement implements SmlProcessStateInstruction {

  public SmlProcessStateInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitProcessStateInstruction(this);
  }
