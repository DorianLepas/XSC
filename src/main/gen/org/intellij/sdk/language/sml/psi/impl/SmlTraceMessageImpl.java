...
public class SmlTraceMessageImpl extends ASTWrapperPsiElement implements SmlTraceMessage {

  public SmlTraceMessageImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitTraceMessage(this);
  }
