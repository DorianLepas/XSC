...
public class SmlExecEndInstructionImpl extends ASTWrapperPsiElement implements SmlExecEndInstruction {

  public SmlExecEndInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmlVisitor visitor) {
    visitor.visitExecEndInstruction(this);
  }
