...
public class SmlCreateEventAliasQuickFix extends BaseIntentionAction {

    private final String key;
    private final PsiElement element;

    public SmlCreateEventAliasQuickFix(String key, PsiElement element) {
        this.key = key;
    ...
    private void createProperty(final Project project) {
        WriteCommandAction.writeCommandAction(project).run(() -> {
            ...
            lastChildNode.addChild(SmlElementFactory.createCRLF(project).getNode());
            lastChildNode.addChild(SmlElementFactory.createAliasBlock(key, project).getNode());
