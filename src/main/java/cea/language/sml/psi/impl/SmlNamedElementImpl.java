...
import cea.language.sml.psi.SmlNamedElement;
...
public abstract class SmlNamedElementImpl extends ASTWrapperPsiElement implements SmlNamedElement {

    public SmlNamedElementImpl(@NotNull ASTNode node) {
        super(node);
    }
