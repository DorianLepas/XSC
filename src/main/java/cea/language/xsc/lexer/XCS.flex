...
STANDART_SECTION=REMOTE_COMMANDS|TRACE_DEFINITIONS|POLLING_EVENT_DEFINITIONS|FORMATTED_RECIPES|OVERWRITTEN_SECS_STANDARD_MESSAGES|PREDEFINED_FORMATTED_STATUS_LISTS|PREDEFINED_UNIQUE_REPORT_ID_REPORTS|PREDEFINED_UNIQUE_CEID_REPORTS|SECSVALUE_TO_VFEITEXTVALUE_VARIABLES|VFEI_TO_NONGEM_MESSAGES
